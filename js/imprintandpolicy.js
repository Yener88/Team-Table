        ...
        <div class="board">
            ...
            <div class="taskinnerwindow">
                <div class="imprintContent">
                    <p>According to § 5 TMG</p><p>Yener Bas <br> 
                    Nievenheimerstr. 1<br> 
                    50739 Köln <br> 
                    </p><p> <strong>Represented by: </strong><br>
                    Yener Bas<br>
                    </p><p><strong>Contact:</strong> <br>
                    E-Mail: yener.bas@outlook.de<br>
                </div>
            </div>
        </div>
    `;
        ...
        <div class="board">
            ...
            <div class="taskinnerwindow">
                <div class="policyContent">
                    ...
                    <li>
                    <p><strong>Website</strong> refers to https://yener-bas.developerakademie.net/Pokedex/index.html, accessible from <a href="https://yener-bas.developerakademie.net/Pokedex/index.html" rel="external nofollow noopener" target="_blank">https://yener-bas.developerakademie.net/Pokedex/index.html</a></p>
                    </li>
                    <li>
                    ...
                    <ul>
                    <li>By email: yener.bas@outlook.de</li>
                    </ul>
                </div>   
            </div>
        </div>
